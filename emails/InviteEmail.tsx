...
export const InviteEmail = ({
  ...
  const displayName = courierName && courierName.trim() ? courierName : "Repartidor";

  return (
    <Html>
      <Head />
      <Preview>Invitación a la plataforma Golden Express</Preview>
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={contentSection}>
            ...
            <Text style={text}>
              Has sido invitado a formar parte del equipo de personal de{" "}
              <strong style={goldText}>Golden Express</strong>.
            </Text>
            <Text style={text}>
              Para activar tu cuenta, definir tu contraseña y completar los detalles de tu perfil, haz clic en el siguiente botón:
            </Text>
          ...
          <Section style={footerSection}>
            <Text style={footerText}>
              Si no esperabas recibir esta invitación, puedes ignorar este mensaje de forma segura.
            </Text>
            <Text style={footerText}>
